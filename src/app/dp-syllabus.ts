...
export const dpHours: Record<string, DpHourRow[]> = {
  "ai-sl": [
    { topic: "Number and Algebra", hours: "12" },
    { topic: "Functions", hours: "19" },
    { topic: "Geometry and Trigonometry", hours: "13" },
    { topic: "Statistics and Probability", hours: "33" },
    { topic: "Calculus", hours: "13" },
    { topic: "Internal Assessment", hours: "10" },
    { topic: "Total", hours: "100" },
  ],
  "ai-hl": [
    { topic: "Number and Algebra", hours: "19" },
    { topic: "Functions", hours: "30" },
    { topic: "Geometry and Trigonometry", hours: "22" },
    { topic: "Statistics and Probability", hours: "49" },
    { topic: "Calculus", hours: "20" },
    { topic: "Internal Assessment", hours: "10" },
    { topic: "Total", hours: "150" },
  ],
  "aa-sl": [
    { topic: "Number and Algebra", hours: "13" },
    { topic: "Functions", hours: "14" },
    { topic: "Geometry and Trigonometry", hours: "16" },
    { topic: "Statistics and Probability", hours: "18" },
    { topic: "Calculus", hours: "29" },
    { topic: "Internal Assessment", hours: "10" },
    { topic: "Total", hours: "100" },
  ],
  "aa-hl": [
    { topic: "Number and Algebra", hours: "25" },
    { topic: "Functions", hours: "26" },
    { topic: "Geometry and Trigonometry", hours: "31" },
    { topic: "Statistics and Probability", hours: "20" },
    { topic: "Calculus", hours: "38" },
    { topic: "Internal Assessment", hours: "10" },
    { topic: "Total", hours: "150" },
  ],
};
